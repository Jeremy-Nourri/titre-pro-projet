...
public class BoardColumnServiceImpl implements BoardColumnService {
    ...
    public BoardColumnDtoResponse getBoardColumn(Long columnId) {
    ...
    @CheckProjectAuthorization
    @Transactional
    public BoardColumnDtoResponse updateBoardColumn(Long columnId, Long projectId, BoardColumnDtoRequest requestDTO) {
